...
from reasoning_agent.schemas import ReasoningOutput, SubjectArea, ConfidenceLevel
...
def create_test_reconstruction_input():
    ...
    original_layout = [
        {"type": "title", "bbox": [50, 50, 500, 100], "text": "Physics: Forces and Motion"},
        {"type": "paragraph", "bbox": [50, 120, 500, 200], "text": "Force is a push..."},
...
def test_reconstruction_pipeline():
    ...
    print(f"   ✅ Created input with {len(reconstruction_input.verified_elements)} verified elements")
    ...
    try:
        ...
        print(f"   Test status: {'✅ PASSED' if result.verifier_passed else '❌ FAILED'}")
